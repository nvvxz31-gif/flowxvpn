      ...
      >
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <div className="text-2xl font-bold" style={{ color: '#F5F5F7' }}>{planName}</div>
          </div>
          <span className="text-xs px-3 py-1 rounded-full font-semibold" style={{ background: isActive ? 'rgba(48,209,88,0.15)' : 'rgba(152,152,157,0.15)', color: isActive ? '#30D158' : '#98989D' }}>
